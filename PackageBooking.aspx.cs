...
public partial class Defaultspa : System.Web.UI.Page
{
 ...
 data1 dc = new data1();
        ...
        var dat = from tmp in dc.PackageTables where tmp.id == Convert.ToInt32( Request.QueryString["i"].ToString()) select tmp;
        if (dat.Count() != 0)
        {
            Label1.Text = dat.First().PackageType;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Literal1.Text == "")
        {
            ...
            PackageBookingTable obj = new PackageBookingTable();
            ...
            obj.PackageId = Convert.ToInt32( HiddenField1.Value);
            obj.Status = "Booked";
            dc.PackageBookingTables.InsertOnSubmit(obj);
