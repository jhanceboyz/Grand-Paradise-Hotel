...
public partial class Defaultspa : System.Web.UI.Page
{
 ...
 data1 dc = new data1();
        ...
        var dat = from tmp in dc.spatharapies where tmp.spaid == Convert.ToInt32( Request.QueryString["i"].ToString()) select tmp;
        if (dat.Count() != 0)
        {
            Label1.Text = dat.First().spatype;
            Label2.Text = dat.First().priceofspa;
            HiddenField1.Value = dat.First().spaid.ToString();
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Literal1.Text == "")
        {
            ...
            spa_booking obj = new spa_booking();
            ...
            obj.spa_id = Convert.ToInt32( HiddenField1.Value);
            obj.Status = "Booked";
            dc.spa_bookings.InsertOnSubmit(obj);
