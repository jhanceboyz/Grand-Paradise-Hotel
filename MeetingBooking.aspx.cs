...
public partial class Defaultspa : System.Web.UI.Page
{
 ...
 data1 dc = new data1();
        ...
        var dat = from tmp in dc.Meetings where tmp.id == Convert.ToInt32( Request.QueryString["i"].ToString()) select tmp;
        if (dat.Count() != 0)
        {
            Label1.Text = dat.First().event_type;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Literal1.Text == "")
        {
            ...
            MeetingBookingTable obj = new MeetingBookingTable();
            ...
            obj.Meeting_id = Convert.ToInt32( HiddenField1.Value);
            obj.Status = "Booked";
            dc.MeetingBookingTables.InsertOnSubmit(obj);
